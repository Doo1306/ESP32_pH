...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 143, ; uint32_t number_of_assemblies_in_apk (0x8f)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 678, ; uint32_t number_of_dso_cache_entries (0x2a6)
	i32 33555137, ; uint32_t android_runtime_jnienv_class_token (0x20002c1)
	i32 100670629, ; uint32_t jnienv_initialize_method_token (0x6001ca5)
	i32 100670628, ; uint32_t jnienv_registerjninatives_method_token (0x6001ca4)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [678 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 96773282821355722, ; hash 0x157cec9ba50b8ca, from name: aot-ESP32pH
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ESP32pH.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
		i64 120698629574877762, ; hash 0x1accec39cafe242, from name: Mono.Android
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.113_name, ; name: libaot-Mono.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.28_name, ; name: libaot-System.Reactive.dll.so
		ptr null; void* handle (0x0)
	}, ; 8
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.102_name, ; name: libaot-System.Threading.Tasks.dll.so
		ptr null; void* handle (0x0)
	}, ; 16
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.87_name, ; name: libaot-System.Reflection.Extensions.dll.so
		ptr null; void* handle (0x0)
	}, ; 19
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.109_name, ; name: libaot-mscorlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 21
	%struct.DSOCacheEntry {
		i64 560278790331054453, ; hash 0x7c6829760de3975, from name: System.Reflection.Primitives
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.88_name, ; name: libaot-System.Reflection.Primitives.dll.so
		ptr null; void* handle (0x0)
	}, ; 22
	%struct.DSOCacheEntry {
		i64 584895086741024446, ; hash 0x81df6fb8411eebe, from name: aot-Microsoft.CSharp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.58_name, ; name: libaot-Microsoft.CSharp.dll.so
		ptr null; void* handle (0x0)
	}, ; 23
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.111_name, ; name: libaot-Java.Interop.dll.so
		ptr null; void* handle (0x0)
	}, ; 32
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.110_name, ; name: libaot-netstandard.dll.so
		ptr null; void* handle (0x0)
	}, ; 42
	%struct.DSOCacheEntry {
		i64 1249162902185008584, ; hash 0x1155eb0a8b555dc8, from name: aot-System.Diagnostics.Debug
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.68_name, ; name: libaot-System.Diagnostics.Debug.dll.so
		ptr null; void* handle (0x0)
	}, ; 43
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.112_name, ; name: libaot-Mono.Android.Runtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 53
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.89_name, ; name: libaot-System.Reflection.dll.so
		ptr null; void* handle (0x0)
	}, ; 63
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.67_name, ; name: libaot-System.Data.Common.dll.so
		ptr null; void* handle (0x0)
	}, ; 69
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.90_name, ; name: libaot-System.Resources.ResourceManager.dll.so
		ptr null; void* handle (0x0)
	}, ; 75
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2485802750440151502, ; hash 0x227f586e61ac99ce, from name: libaot-ESP32pH
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ESP32pH.dll.so
		ptr null; void* handle (0x0)
	}, ; 88
	...
	%struct.DSOCacheEntry {
		i64 3634544395678783861, ; hash 0x32707edf08d21975, from name: System.ServiceModel
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-System.ServiceModel.dll.so
		ptr null; void* handle (0x0)
	}, ; 131
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.114_name, ; name: libaot-System.Private.CoreLib.dll.so
		ptr null; void* handle (0x0)
	}, ; 134
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6278026249493579436, ; hash 0x5720079c8ba486ac, from name: aot-System.ServiceModel
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-System.ServiceModel.dll.so
		ptr null; void* handle (0x0)
	}, ; 204
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.99_name, ; name: libaot-System.Text.Encoding.dll.so
		ptr null; void* handle (0x0)
	}, ; 235
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 9436605714725137416, ; hash 0x82f58ee6779cec08, from name: libaot-System.ServiceModel
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-System.ServiceModel.dll.so
		ptr null; void* handle (0x0)
	}, ; 334
	...
	%struct.DSOCacheEntry {
		i64 10511776846248832076, ; hash 0x91e155590ed66c4c, from name: ESP32pH.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ESP32pH.dll.so
		ptr null; void* handle (0x0)
	}, ; 380
	...
	%struct.DSOCacheEntry {
		i64 11025748530928831694, ; hash 0x990353df38cc4cce, from name: System.ServiceModel.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-System.ServiceModel.dll.so
		ptr null; void* handle (0x0)
	}, ; 394
	...
	%struct.DSOCacheEntry {
		i64 12213219525986026399, ; hash 0xa97e12735243039f, from name: libaot-ESP32pH.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ESP32pH.dll.so
		ptr null; void* handle (0x0)
	}, ; 446
	...
	%struct.DSOCacheEntry {
		i64 13372857449547785172, ; hash 0xb995eeff783b63d4, from name: libaot-System.ServiceModel.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-System.ServiceModel.dll.so
		ptr null; void* handle (0x0)
	}, ; 494
	...
	%struct.DSOCacheEntry {
		i64 13634818816502981494, ; hash 0xbd389b792678e376, from name: aot-System.ServiceModel.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-System.ServiceModel.dll.so
		ptr null; void* handle (0x0)
	}, ; 501
	...
	%struct.DSOCacheEntry {
		i64 14423219658244587134, ; hash 0xc82991dc97197e7e, from name: ESP32pH
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ESP32pH.dll.so
		ptr null; void* handle (0x0)
	}, ; 538
	...
	%struct.DSOCacheEntry {
		i64 16991344964010298465, ; hash 0xebcd623883f4cc61, from name: aot-ESP32pH.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ESP32pH.dll.so
		ptr null; void* handle (0x0)
	}, ; 625
...
@.env.3 = private unnamed_addr constant [37 x i8] c"8bd52f6c-4130-4a70-ba90-d807ed39da63\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [16 x i8] c"ESP32pH.ESP32pH\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-ESP32pH.dll.so\00", align 16
...
@.DSOCacheEntry.25_name = private unnamed_addr constant [34 x i8] c"libaot-System.ServiceModel.dll.so\00", align 16
...
@.DSOCacheEntry.28_name = private unnamed_addr constant [30 x i8] c"libaot-System.Reactive.dll.so\00", align 16
...
@.DSOCacheEntry.58_name = private unnamed_addr constant [31 x i8] c"libaot-Microsoft.CSharp.dll.so\00", align 16
...
@.DSOCacheEntry.67_name = private unnamed_addr constant [33 x i8] c"libaot-System.Data.Common.dll.so\00", align 16
@.DSOCacheEntry.68_name = private unnamed_addr constant [39 x i8] c"libaot-System.Diagnostics.Debug.dll.so\00", align 16
...
@.DSOCacheEntry.87_name = private unnamed_addr constant [43 x i8] c"libaot-System.Reflection.Extensions.dll.so\00", align 16
@.DSOCacheEntry.88_name = private unnamed_addr constant [43 x i8] c"libaot-System.Reflection.Primitives.dll.so\00", align 16
@.DSOCacheEntry.89_name = private unnamed_addr constant [32 x i8] c"libaot-System.Reflection.dll.so\00", align 16
@.DSOCacheEntry.90_name = private unnamed_addr constant [47 x i8] c"libaot-System.Resources.ResourceManager.dll.so\00", align 16
...
@.DSOCacheEntry.99_name = private unnamed_addr constant [35 x i8] c"libaot-System.Text.Encoding.dll.so\00", align 16
...
@.DSOCacheEntry.102_name = private unnamed_addr constant [37 x i8] c"libaot-System.Threading.Tasks.dll.so\00", align 16
...
@.DSOCacheEntry.107_name = private unnamed_addr constant [35 x i8] c"libaot-System.Xml.XDocument.dll.so\00", align 16
@.DSOCacheEntry.108_name = private unnamed_addr constant [21 x i8] c"libaot-System.dll.so\00", align 16
@.DSOCacheEntry.109_name = private unnamed_addr constant [23 x i8] c"libaot-mscorlib.dll.so\00", align 16
@.DSOCacheEntry.110_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 16
@.DSOCacheEntry.111_name = private unnamed_addr constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 16
@.DSOCacheEntry.112_name = private unnamed_addr constant [35 x i8] c"libaot-Mono.Android.Runtime.dll.so\00", align 16
@.DSOCacheEntry.113_name = private unnamed_addr constant [27 x i8] c"libaot-Mono.Android.dll.so\00", align 16
@.DSOCacheEntry.114_name = private unnamed_addr constant [37 x i8] c"libaot-System.Private.CoreLib.dll.so\00", align 16

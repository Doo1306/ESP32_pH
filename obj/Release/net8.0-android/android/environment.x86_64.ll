...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 142, ; uint32_t number_of_assemblies_in_apk (0x8e)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 672, ; uint32_t number_of_dso_cache_entries (0x2a0)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [672 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.101_name, ; name: libaot-System.Threading.Tasks.dll.so
		ptr null; void* handle (0x0)
	}, ; 16
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.108_name, ; name: libaot-mscorlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 21
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.109_name, ; name: libaot-netstandard.dll.so
		ptr null; void* handle (0x0)
	}, ; 42
	%struct.DSOCacheEntry {
...
@.env.3 = private unnamed_addr constant [37 x i8] c"f763226f-4a32-4b62-a91c-467f9ee0ee25\00", align 16
...
@.DSOCacheEntry.101_name = private unnamed_addr constant [37 x i8] c"libaot-System.Threading.Tasks.dll.so\00", align 16
...
@.DSOCacheEntry.108_name = private unnamed_addr constant [23 x i8] c"libaot-mscorlib.dll.so\00", align 16
@.DSOCacheEntry.109_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 16
